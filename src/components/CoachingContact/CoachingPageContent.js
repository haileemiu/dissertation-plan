...
class CoachingPageContent extends Component {
  state = {}
  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        {/* Coaches Section */}
        <p className={classes.sectionHeadings}>Our Coaches</p>
        <div className={classes.coachesGrid}>
        ...
        {/* Define Section */}
        <p className={classes.sectionHeadings}>What is coaching?</p>
        ...
        {/* Philosophy Section */}
        <p className={classes.sectionHeadings}>Our Coaching Philosophy</p>
        ...
        {/* Bulleted Help List */}
        <p className={classes.sectionHeadings}>Your Dissertation Liberation Coach Can Help You To:</p>
        <ul>
        ...
        {/* Bottom */}
        <p
          className={classes.sectionHeadings}
